...
DATASET_PATHS_BY_CLUSTER = {
    CLUSTER:{
        'IntPhys-dev-O1': '/data/linux/wkx/IntPhys/data/dev/O1',
        'IntPhys-dev-O2': '/data/linux/wkx/IntPhys/data/dev/O2',
        'IntPhys-dev-O3': '/data/linux/wkx/IntPhys/data/dev/O3',
        'IntPhys-train': '/data/linux/wkx/IntPhys/data/train',
